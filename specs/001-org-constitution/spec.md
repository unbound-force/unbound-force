...
- **Speckit pipeline mechanics**: Defined by [[specs/003-specification-framework/spec]] (Specification Framework). The constitution recommends spec-driven development but does not define the pipeline stages or commands.
